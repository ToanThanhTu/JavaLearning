...
//        LinkedList<String> placesToVisit = new LinkedList<>();
        var placesToVisit = new LinkedList<String>(); // if use var, need to put "String" on the right side.
...
//        testIterator(placesToVisit);
    ...
    private static void addMoreElements(LinkedList<String> list) {
        ...
        // Queue methods
        list.offer("Melbourne"); // add to last
        list.offerFirst("Brisbane");
        list.offerLast("Toowoomba");

        // Stack methods
        list.push("Alice Springs"); // add to first
    ...
    private static void removeElements(LinkedList<String> list) {
        ...
        String s2 = list.remove(); // remove first
        ...
        String p2 = list.pollFirst(); // remove first
